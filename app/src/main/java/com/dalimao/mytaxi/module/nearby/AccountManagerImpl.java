...
import com.dalimao.mytaxi.model.SmsCodeResponse;
import com.dalimao.mytaxi.model.UserExistResponse;
        ...
        RxBus.getInstance().chainProcess(new Func1() {
            ...
            public Object call(Object o) {
                ...
                if (response.getCode() == BaseResponse.STATE_OK) {
                    ...
                    bizRes.setCode(BaseBizResponse.STATE_OK);
                    if (bizRes.getCode() == BaseBizResponse.STATE_OK) {
    ...
    public void register(final String phone, final String password) {
        RxBus.getInstance().chainProcess(new Func1() {
            ...
            public Object call(Object o) {
                ...
                request.setBody("uid", DevUtil.UUID(App.getInstance()));
